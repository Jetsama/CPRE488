...
HD_PWD='U:/CprE488/Labs/MP-0/mp_0/mp_0.runs/zynq_design_1_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_design_1_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_design_1_xbar_1.tcl
