...
HD_PWD='U:/CprE488/Labs/MP-0/mp_0/mp_0.runs/zynq_design_1_axi_gpio_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_design_1_axi_gpio_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_design_1_axi_gpio_2_0.tcl
