...
HD_PWD='U:/CprE488/Labs/MP-0/mp_0/mp_0.runs/zynq_design_1_v_axi4s_vid_out_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_design_1_v_axi4s_vid_out_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_design_1_v_axi4s_vid_out_0_2.tcl
